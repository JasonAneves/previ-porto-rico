 ...
 <body>
 	...
 	<footer>
 		<?php
			...
			include "paginas/09-horario-atendimento/09-horario-atendimento.php";
			include "paginas/10-dados-rodape/10-dados-rodape.php";
			// include "paginas/botoes-rodape-responsivo/botoes.php";
			?>
 	</footer>
