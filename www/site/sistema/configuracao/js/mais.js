					...
					'<div class="input-group">' +
						'<span class="input-group-btn">' +
							'<span class="btn btn-primary btn-file">' +
								...
								'<input type="file" accept="image/jpeg, image/png" name="imagem[]">' +
							'</span>' +
						'</span>' +
...
function maisAlternativa() {
	...
	var el = 
		'<div>' +
			...
			'<div class="form-group">' +
				'<label class="col-sm-2 control-label">Alternativa</label>' +
				'<div class="col-sm-10">' +	
					'<input type="text" name="alternativas[]" class="form-control" placeholder="Informe a alternativa...">' + 
				'</div>' +
			'</div>' +
			
		'</div>';
	$(el).insertAfter('#mais-alternativa');
}

function maisAlternativa2() {
	...
	var el = 
		'<div>' +
			...
			'<div class="form-group">' +	
				...
				'<div class="col-sm-10">' +	
					'<div class="input-group">' +
						'<input type="text" name="alternativas[]" class="form-control" placeholder="Informe a alternativa..." required>' + 
						'<span class="input-group-btn">' +
							'<button type="button" class="btn btn-danger" onclick="jQuery(this).parent().parent().parent().parent().parent().fadeOut(\'slow\', function(){jQuery(this).remove();})"><i class="fa fa-trash"></i></button>' +
						'</span>' +
					'</div>' +
