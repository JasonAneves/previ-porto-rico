...
(function (root, factory) {
    ...
    var defaults = {
        ...
        // largura
        width: 500,
        // Altura, excluindo cabeça, altura fixa da cabeça
        height: 500,

        zIndex: 1,

        // selector
        // Defina o elemento que aciona a exibição, que é exibida por padrão quando é nula
        trigger: null,

        // Posição de deslocamento, valores positivos e negativos podem ser definidos
        // trigger Efetivo quando definido
        offset: [0, 1],

        // Classe personalizada para reescrever estilos
        customClass: '',
        ...
        // 0 significa domingo e assim por diante
        startWeek: 0,

        // Formato da semana
        weekArray: ['D', 'S', 'T', 'Q', 'Q', 'S', 'S'],

        // Formato do mês
        monthArray: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'],

        // Definir faixa de seleção
        // Formato: [data de início, data de término]
        // Se a data de início estiver vazia, não haverá limite superior; se a data de término estiver vazia, não haverá limite inferior
        // Se a configuração não estiver disponível antes de 23 de novembro de 2015: [nova Data (), null] ou ['2015/11/23']
        selectedRang: null,

        // Dados relacionados à data [{date: string, value: object}, ...]
        // O formato da data é consistente com o formato
        // Como [{date: '2015/11/23', valor: 'Interview'}]
        data: null,

        // Exibir dados relacionados
        // Parâmetros de formatação: {m} visualização, {d} data, valor {v}
        // Defina false para não exibir
        label: '{d}\n{v}',
        ...
        // view: Visão
        // date: Vistas diferentes retornam valores diferentes
        // value: Dados relacionados à data
    ...
    Calendar.prototype = {
        ...
        getDayItem: function (y, m, d, f) {
            ...
            if (markData){
                data['class'] += ' ' + MARK_DAY_HTML_CLASS;
            }
