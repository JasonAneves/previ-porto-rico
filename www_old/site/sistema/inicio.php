<?php
include "../../../privado/config_cliente.php";
include "../../../privado/sistema/conexao.php";

if(!$_COOKIE["id_usuario"]) {
    echo"<script>window.location='index.php?msg=".urlencode('A sessão expirou! Faça login novamente.')."'</script>";
} else {
?>
	<!DOCTYPE html>
	<html lang="pt-br">
		<head>
			...
			<link rel="shortcut icon" href="<?= $caminhoImg ?>/favicon.ico" />
			...
			<script type="text/javascript" src="<?= $CAMINHOJS ?>/jquery.maskedinput.js"></script>
			...
			<script src="https://cdn.ckeditor.com/4.5.4/full/adapters/jquery.js"></script>
		...
		<body>
			<div class="wrapper">
				<?php include "../../../privado/sistema/menu.php"; ?>
				<div id="content">
					...
					<div class="col-md-12" id="conteudo" onclick="menu_lateral()">
						<?php include "../../../privado/sistema/sequencia.php"; ?>
					</div>
				</div>			
			</div>
			<?php
