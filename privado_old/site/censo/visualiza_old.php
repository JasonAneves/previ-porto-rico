...
if($id){
	...
	?>
      ...
      <div style='display: block;width: 100%;'>
        <h1 class="acessibilidade" style=" color: #0aab60;font-size: 35px;font-weight: bold;font-family: 'Muli', sans-serif;">Censo / <?=$registro['titulo']?></h1>
      </div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					foreach($fotos->fetchAll(PDO::FETCH_ASSOC) as $foto){
						...
						$img = getimagesize($CAMINHOIMG."/".$cliente."/".$foto['foto']) ? $CAMINHOIMG."/".$cliente."/".$foto['foto'] : $CAMINHOIMGCSS."/sem_foto.jpg";
