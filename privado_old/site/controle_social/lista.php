<div class="row" style="margin:0;">
    <div class="container" style="min-height: 500px;">
			<h2 style="color: #0aab60;font-size: 35px;font-weight: bold;font-family: 'Muli', sans-serif;">Controle Social</h2>
<?php
		$categoriaId = $url[$ii];
		$whereCat = " AND id = ".$categoriaId." ";
		$qryCat = Conexao::chamar()->prepare("SELECT * FROM controle_social_categoria WHERE status_registro = 'A' {$whereCat} ORDER BY descricao DESC");
		$qryCat->execute();
    ...
    foreach($BuscaCat as $cat){
			...
			$qryArtigo = Conexao::chamar()->prepare("SELECT * FROM controle_social WHERE id_categoria = '$cat[id]' AND status_registro = 'A' ORDER BY id DESC");
			$qryArtigo->execute();
	            ...
	            <div class="panel panel-default">
	                ...
	                <div id="<?=$count?>" class="panel-collapse collapse">
	                    <div class="panel-body">
												...
												<? }  ?>
										 <? $qryAnexo = Conexao::chamar()->prepare("SELECT * FROM controle_social_anexo WHERE id_artigo='$busca_artigo[id]' ORDER BY ordem ASC, id DESC") or die(mysql_error());
												$qryAnexo->execute();
