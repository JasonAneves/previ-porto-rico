...
if($id){
	...
	if(isset($registro['id'])){
		...
		if(isset($fotoArtigo['id'])){
			$y = $CAMINHOIMG."/".$fotoArtigo['foto'];
			$img = ($y =! null )? $CAMINHOIMG."/".$fotoArtigo['foto'] : $CAMINHOIMG."/semfoto.png";
			$img_light = ($y =! null ) ? $CAMINHOIMG."/".$fotoArtigo['foto'] : $CAMINHOIMG."/semfoto.png";
		}
	...
	?>
      ...
      <div style='display: block;width: 100%;'>
        <h1 class="acessibilidade" style=" color: #0aab60;font-size: 35px;font-weight: bold;font-family: 'Muli', sans-serif;">Institucional / <?=$registro['titulo']?></h1>
      </div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					foreach($fotos->fetchAll(PDO::FETCH_ASSOC) as $foto){
						...
						$img = getimagesize($CAMINHOIMG."/".$foto['foto']) ? $CAMINHOIMG."/".$foto['foto'] : $CAMINHOIMG."/semfoto.png";
