    ...
    <form id="form-cadastro" action="" enctype="multipart/form-data" data-toggle="validator" method="post">
        <div class="card-form">
            ...
            <div class="card-form-body">
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <label for="link_banner" class="control-label">Link</label>
                        <input type="url"
                               name="link_banner"   
                               id="link_banner" value="<?= $object['url'] ?>"
                ...
                <div class="row">
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="input-group date">
                            <input 
                                ...
                                name="data_limite" 
                                id="data_limite" 
                                value="<?= formata_data($object['data_limite']) ?>"
                                class="form-control data input"/>
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        ...
                        <input type="time"
                               name="hora_limite" 
                               id="hora_limite" 
                               value="<?= empty($id) ? '' : $object['hora_limite'] ?>"
                               class="form-control input"/>
                    </div>
                </div>
            </div>
