                ...
                <div class="row" style="padding-top: 15px;">
                    <div class="form-group">
                        ...
                        <label for="subcategoria" class="control-label">Subcategoria</label>
                            <div class="input-group">
                                <span class="input-group-addon input">
                                    <a  href="#" onclick="popup('<?= $publicoSistema ?>/popup/ata_subcategoria.php?tela=<?= $tela ?>&id_categoria='+jQuery('#id_categoria').val(), 'Subcategorias')">
                                        <i class="fa fa-search"></i>
                                    </a>
                                </span> 
                                <input 
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-3 div-despesa-file form-group">
                                <?php if(!empty($object['arquivo'])) { ?>
                                    ...
                                    <a  href="#" onclick="excluirArquivo('<?= $id ?>', 'ata', 'arquivo', 'arquivo', '<?= $caminhoTela ?>&id=<?= $id ?>&s=alterar');"
                                        type="button" 
