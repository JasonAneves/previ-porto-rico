                    ...
                    <td class="text-center">
                        <?php if($object['status_registro'] == "A") {
                            ...
                            for($i = 0; $i <= $totalCadastrosFilhos; $i++){
                                if ($object['id'] == $qryCadastrosFilhos[$i]['id_nivel2']   ||
                                    $object['id'] == $qryCategoria_2Filhos[$i]['id_nivel2'] ||
                                    $object['id'] == $qryCategoria_1Filhos[$i]['id_nivel1']) {
                                    $podeExcluir = true;
                                }
                            }
                            ?>
                            ...
                            <?php } else { ?>
                                <a  href="#" 
                                    ...
                                    onclick="restaurar('<?= $tb_nivel_1 ?>', '<?= $object['id'] ?>', '<?= $caminhoTela ?>');"
                                    data-toggle="tooltip" 
                                    data-placement="right" 
