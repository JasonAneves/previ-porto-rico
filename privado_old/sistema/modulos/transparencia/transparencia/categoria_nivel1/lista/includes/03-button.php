<div class="div-button">
    <nav class="pull-right hidden-xs hidden-sm">
        <?php if ($idUsuarioMaster) { ?>
            <a href="#" onclick="popup('<?= $publicoSistema ?>/popup/log/log_listagem.php?tela=<?= $tela ?>', 'Registro de Logs de Acesso')" class="btn btn-info pull right">
    ...
    <nav class="visible-xs visible-sm">
        <?php if ($idUsuarioMaster) { ?>
            <a href="#" onclick="popup('<?= $publicoSistema ?>/popup/log/log_listagem.php?tela=<?= $tela ?>', 'Registro de Logs de Acesso')" class="btn btn-info btn-block">
                <i class="fa fa-bar-chart"></i> Log de Acesso
            </a>
        <?php } ?>
        <?php if ($cadastrar) { ?>
