    ...
    <div class="table-responsive hidden-sm hidden-xs">
        <table class="table table-striped table-hover table-bordered table-condensed">
            <tr class="active grid-topico">
                <th style="width: 90px;">
                    <?php
                        if(count($qryCadastrosFilhos) == 0 && (empty($statusRegistro) || $statusRegistro == "A")) { ?>
                        <input type="checkbox"
                            id="marcar"
                            name="marcar"
                        ...
                        <td class="text-center">
                            <?php if($object['status_registro'] == "A") { ?>
                                ...
                                for($i = 0; $i <= $totalCadastrosFilhos; $i++){
                                    if ($object['id'] == $qryCadastrosFilhos[$i]['id_nivel3']) {
                                        $podeExcluir = false;
                                    }
                                }
                                ?>
                            ...
                            <?php } else { ?>
                                <a  href="#"
                                    ...
                                    onclick="restaurar('<?= $tb_nivel_3 ?>', '<?= $object['id'] ?>', '<?= $caminhoTela ?>');"
                                    data-toggle="tooltip"
                                    data-placement="right"
