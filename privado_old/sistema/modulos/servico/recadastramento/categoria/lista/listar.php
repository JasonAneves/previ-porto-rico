...
$tabela = 'recadastramento_categoria';
if ($idExcluir) {
		...
		<div class="card-list">
			<?php
                ...
                try {
                    ...
                    $selectSubcategoriasFilhos = "SELECT *
                                           FROM recadastramento_subcategoria 
                                           WHERE id_categoria IN (
                                               SELECT id 
                                               FROM $tabela
                                               WHERE id_cliente = $idCliente
                    ...
                    $stSubcategoriasFilhos = Conexao::chamar()->prepare($selectSubcategoriasFilhos);
                    $stSubcategoriasFilhos->execute();
                    $qrySubcategoriasFilhos = $stSubcategoriasFilhos->fetchAll(PDO::FETCH_ASSOC);
                    $totalSubcategoriasFilhos = count($qrySubcategoriasFilhos);

                    $totalRegistrosFilhos = $totalCadastrosFilhos + $totalSubcategoriasFilhos;
