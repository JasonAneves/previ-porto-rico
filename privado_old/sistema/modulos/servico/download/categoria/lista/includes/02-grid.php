    ...
    <div class="table-responsive hidden-sm hidden-xs">
        <table class="table table-striped table-hover table-bordered table-condensed">
            <tr class="active grid-topico">
                ...
                <th>
                    <a  href="<?= $link ?>&tela=<?= $tela ?>&sort=descricao&direction=<?= empty($direction) || $direction == "DESC" ? "ASC" : "DESC" ?>" 
                        data-toggle="tooltip" 
                        data-placement="top" 
                        ...
                        <td class="text-center">
                            <?php if($object['status_registro'] == "A") {
                                ...
                                for($i = 0; $i <= $totalCadastrosFilhos; $i++){
                                    if ($object['id'] == $qryCadastrosFilhos[$i]['id_categoria'] || $object['id'] == $qrySubcategoriasFilhos[$i]['id_categoria']) {
                                        $podeExcluir = false;
                                    }
                                }
                                ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a  href="#"
                                        ...
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="Não é possível excluir! Existe(m) <?= $totalRegistrosFilhos ?> registro(s) vinculado(s) à esta categoria.">
                                        <i class="fa fa-trash-o"></i>
                                    </a>
                                <?php } ?>
                                <?php if($cadastrar) { ?>
