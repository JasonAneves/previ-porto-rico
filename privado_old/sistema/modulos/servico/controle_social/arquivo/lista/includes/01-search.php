            ...
            <div style="margin: 15px;">
                ...
                <div class="form-group">
                    ...
                    <label for="subcategoria" class="control-label">Subcategoria</label>
                        <div class="input-group">
                            <span class="input-group-addon input">
                                <a  href="#" onclick="popup('<?= $publicoSistema ?>/popup/<?= $tabelaSubcategoria ?>.php?tela=<?= $tela ?>&id_categoria='+jQuery('#id_categoria').val(), 'Categorias')"
                                    <i class="fa fa-search"></i>
                                </a>
                            </span> 
                            <input 
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <label for="titulo" class="control-label">Descricao</label>
                        <input 
                            type="text" 
                            name="titulo"
                            id="titulo"
