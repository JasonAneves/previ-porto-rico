...
session_start();
include "..".DS."..".DS."privado".DS."sistema".DS."conexao.php";
include "..".DS."..".DS."privado".DS."sistema".DS."classes".DS."modelo_email.php";

$CAMINHO = "http://www.cisaamerios.com.br/";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
	...
	if($_SESSION['validacao']) {
		...
		if(!empty($buscaUsuario['id'])) {
			...
			if($update) {
				...
				$lista_email = array();
				$lista_email[0]['email'] = $buscaUsuario['email'];
				$lista_email[0]['nome'] = $nome;

				$vai = envia_email($lista_email, html_entity_decode($subject), $html, $headers, [], '/cisaamerios.com.br/privado/sistema/recupera_senha.php');;
