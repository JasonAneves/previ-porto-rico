    ...
    <div class="table-responsive hidden-sm hidden-xs">
        <table class="table table-striped table-hover table-bordered table-condensed">
            <tr class="active grid-topico">
                ...
                <th>
                    <a  href="<?= $link ?>&tela=<?= $tela ?>&sort=censo_subcategoria.descricao&direction=<?= empty($direction) || $direction == "DESC" ? "ASC" : "DESC" ?>"
                        data-toggle="tooltip" 
                        data-placement="top" 
                        title="Clique para ordenar">
                        Descrição
                    </a>
                    <?php if($sort == "censo_subcategoria.descricao" && $direction == "ASC") { ?><i class="fa fa-caret-up"></i><?php } ?>
                    <?php if($sort == "censo_subcategoria.descricao" && $direction == "DESC") { ?><i class="fa fa-caret-down"></i><?php } ?>
                </th>
                <th>
                    <a  href="<?= $link ?>&tela=<?= $tela ?>&sort=censo_subcategoria.descricao&direction=<?= empty($direction) || $direction == "DESC" ? "ASC" : "DESC" ?>"
                        data-toggle="tooltip" 
                ...
                <th>
                    <a  href="<?= $link ?>&tela=<?= $tela ?>&sort=censo_categoria.descricao&direction=<?= empty($direction) || $direction == "DESC" ? "ASC" : "DESC" ?>"
                        data-toggle="tooltip" 
                        data-placement="top" 
                        title="Clique para ordenar">
                        Categoria
                    </a>
                    <?php if($sort == "censo_categoria.descricao" && $direction == "ASC") { ?><i class="fa fa-caret-up"></i><?php } ?>
                    <?php if($sort == "censo_categoria.descricao" && $direction == "DESC") { ?><i class="fa fa-caret-down"></i><?php } ?>
