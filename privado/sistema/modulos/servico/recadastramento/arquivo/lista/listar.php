...
$tabela             = 'recadastramento_anexo';
$tabelaCategoria    = 'recadastramento_categoria';
$tabelaSubcategoria = 'recadastramento_subcategoria';
	...
	<form id="form_lista" name="form_lista" action="<?= $caminhoTela ?>" method="POST" onsubmit="return excluirVarios();">
		<div class="card-list">
			...
			try {
				...
				if ($descricao != "") {
					$sql .= "AND " . $tabela . ".descricao LIKE :descricao ";
