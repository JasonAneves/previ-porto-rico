		...
		<div class="card-list">
			<?php
                ...
                try {
                    ...
                    $stRegistrosFilhos = Conexao::chamar()->prepare($selectRegistrosFilhos);
                    $stRegistrosFilhos->execute();
                    $qryRegistrosFilhos = $stRegistrosFilhos->fetchAll(PDO::FETCH_ASSOC);
                    $totalRegistrosFilhos = count($qryRegistrosFilhos);
