<?php
    try {
        ...
        if(empty($id)) {
            $stCadastro = Conexao::chamar()->prepare("INSERT INTO telefone_util 
            ...
            if($cadastro) {
                ...
                include_once "05-saveTelefoneUtilNumeros.php";
            ...
            $stCadastro = Conexao::chamar()->prepare("UPDATE telefone_util 
