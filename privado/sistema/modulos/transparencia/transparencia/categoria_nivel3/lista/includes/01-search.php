    ...
    <div class="card-form">
		...
		<div class="card-form-body">
            ...
            <div class="form-group">
                    <div class="col-sm-12">
                    <label for="instituicao" class="control-label">Obras Unidas</label>
                        <div class="input-group">
                            <span class="input-group-addon input">
                            <a  href="#" onclick="popup('<?= $publicoSistema ?>/popup/instituicao.php?tela=<?= $tela ?>', 'Instituições')">
                ...
                <div class="form-group">
                    ...
                    <label for="categoria" class="control-label">Categoria N&iacute;vel 01</label>
                        <div class="input-group">
                            <span class="input-group-addon input">                               
                                <a  href="#" onclick="popup('<?= $publicoSistema ?>/popup/transparencia_categoria.php?tela=<?= $tela ?>&id_instituicao='+jQuery('#id_instituicao').val(), 'Categoria N&iacute;vel 01')">
                                    <i class="fa fa-search"></i>
                                </a>
                            </span>
                            <input 
                ...
                <div class="form-group">
                    ...
                    <label for="categoria" class="control-label">Categoria N&iacute;vel 02</label>
                        <div class="input-group">
                            <span class="input-group-addon input">
                            <a  href="#" onclick="popup('<?= $publicoSistema ?>/popup/transparencia_subcategoria.php?tela=<?= $tela ?>&id_categoria='+jQuery('#id_categoria').val(), 'Categoria N&iacute;vel 02')">
                                    <i class="fa fa-search"></i>
                                </a>
                            </span> 
                            <input 
