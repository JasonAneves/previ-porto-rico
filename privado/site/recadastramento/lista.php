<div class="row" style="margin:0;">
    <div class="container" style="min-height: 500px; padding: 20px 15px;">
			<h2 style="color: #007CC2;font-size: 35px;font-weight: bold;font-family: 'Muli', sans-serif;">Recadastramento</h2>
      <?php
        $qryCat = Conexao::chamar()->prepare("SELECT * FROM recadastramento_categoria WHERE id_cliente = '$idCliente' AND status_registro = 'A' ORDER BY descricao ASC");
        $qryCat->execute();
        ...
        <div class="panel panel-default">
          ...
          <div id="sub<?=$i?>" class="panel-collapse collapse" style="margin-top: -10px;">
            <?php //arquivo sem subcategoria
              $qryAnexoSemSub = Conexao::chamar()->prepare("SELECT * FROM recadastramento_anexo WHERE id_cliente = '$idCliente' AND id_categoria = '$cat[id]' AND id_subcategoria IS NULL AND status_registro = 'A' ORDER BY id DESC");
            ...
            <?php //subcategoria
              $qrySub = Conexao::chamar()->prepare("SELECT * FROM recadastramento_subcategoria WHERE id_cliente = '$idCliente' AND id_categoria = '$cat[id]' AND status_registro = 'A' ORDER BY id DESC");
              $qrySub->execute();
            ...
            <?php //anexo
              $qryAnexo = Conexao::chamar()->prepare("SELECT * FROM recadastramento_anexo WHERE id_cliente = '$idCliente' AND id_categoria = '$cat[id]' AND id_subcategoria = '$sub[id]' AND status_registro = 'A' ORDER BY id DESC");
              $qryAnexo->execute();
